...
"""Compatibility shim for moved modern module.

Canonical module:
    link_core.modern.modern_context_budget
"""

from link_core.modern.modern_context_budget import *  # noqa: F401,F403

if __name__ == "__main__":
    import runpy
    from pathlib import Path
    runpy.run_path(
        str(Path(__file__).resolve().parent / "link_core" / "modern" / "modern_context_budget.py"),
        run_name="__main__",
    )
