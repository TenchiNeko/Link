...
Canonical module:
    link_core.autonomy.link_autonomous
"""

from link_core.autonomy.link_autonomous import *  # noqa: F401,F403
...
if __name__ == "__main__":
    ...
    runpy.run_path(
        str(Path(__file__).resolve().parent / "link_core" / "autonomy" / "link_autonomous.py"),
        run_name="__main__",
    )
