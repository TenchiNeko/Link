...
Canonical module:
    link_core.runtime.link_loop_state
"""

from link_core.runtime.link_loop_state import *  # noqa: F401,F403
...
if __name__ == "__main__":
    ...
    runpy.run_path(
        str(Path(__file__).resolve().parent / "link_core" / "runtime" / "link_loop_state.py"),
        run_name="__main__",
    )
